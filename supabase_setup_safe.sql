-- SAFE Supabase Database Setup Script for Numerizam Accounting System
...
-- This will automatically drop associated policies, triggers, and indexes
...
-- Drop existing functions (triggers are dropped with tables)
